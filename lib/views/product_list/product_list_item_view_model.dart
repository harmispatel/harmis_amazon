...
class ProductListItemViewModel with ChangeNotifier {
  ...
  void addToCart({String productId}) async {
    ...
    deviceToken = await appPreferences.getDeviceToken();
      ...
      if (master != null) {
        if (master.success == 1) {
         /* print("message=>"+master.message.toString());*/
          CommonUtils.showGreenToastMessage(master.message.toString().replaceAll('labels.', ''));
