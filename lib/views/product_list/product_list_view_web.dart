...
class ProductListViewWeb extends StatefulWidget {
  String categoryId;

  ProductListViewWeb({this.categoryId});

  @override
  _ProductListViewWebState createState() => _ProductListViewWebState();
}

class _ProductListViewWebState extends State<ProductListViewWeb> {
