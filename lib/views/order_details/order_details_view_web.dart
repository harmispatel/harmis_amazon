...
class OrderDetailsViewWeb extends StatefulWidget {
  String orderId;

  OrderDetailsViewWeb({this.orderId});

  @override
  _OrderDetailsViewWebState createState() => _OrderDetailsViewWebState();
}

class _OrderDetailsViewWebState extends State<OrderDetailsViewWeb> {
                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              border:
                                  Border.all(color: CommonColors.lightGrey)),
                          child: Column(
                            children: [
