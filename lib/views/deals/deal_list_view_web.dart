...
class DealListViewWeb extends StatefulWidget {
  @override
  _DealListViewWebState createState() => _DealListViewWebState();
}

class _DealListViewWebState extends State<DealListViewWeb> {
