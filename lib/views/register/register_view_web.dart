  ...
  Widget build(BuildContext context) {
    ...
    final layoutBirthDate = InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            ...
            border: Border(
                bottom:
                    BorderSide(color: CommonColors.primaryColor, width: 1))),
        child: Padding(
    ...
    final btnRegister = InkWell(
      onTap: () {
        ...
        signUpRequest.mobileNumber = mMobileController.text;
        signUpRequest.countryId =
            mViewModel.selectedNationality.countryId.toString();
        ...
        mViewModel.verifyPhone(
            ...
            phoneNumber: mMobileController.text,
            onCodeSent: () {},
            context: context);
        //}
      },
      ...
      onTap: () async {
        await launch(
          mViewModel.languageCode != null &&
                  mViewModel.languageCode == AppConstants.LANGUAGE_ENGLISH
            ...
            Container(
              ...
              child: Padding(
                ...
                child: Column(children: [
                  ...
                  layoutTitle,
                  setTextField(
                      S.of(context).firstname, mFirstNameController, true),
                  setTextField(
                      S.of(context).lastname, mLastNameController, true),
                  layoutMobileNumber,
                  setTextField(
