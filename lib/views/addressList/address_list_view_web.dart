...
import 'package:big_mart/views/addressList/address_list_item_web.dart';
import 'package:big_mart/views/checkout/checkout_view_web.dart';
...
class AddressListViewWeb extends StatefulWidget {
  List<CartDetails> cartList;
  String totalPrice;
  String orderId;

  AddressListViewWeb({this.cartList, this.totalPrice, this.orderId});

  @override
  _AddressListViewWebState createState() => _AddressListViewWebState();
}

class _AddressListViewWebState extends State<AddressListViewWeb> {
